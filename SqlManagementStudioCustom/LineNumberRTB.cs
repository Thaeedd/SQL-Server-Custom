...
namespace LineNumberRichTextBoxDemo
{
    public partial class LineNumberRTB : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.richTextBox.Size = new System.Drawing.Size(481, 358);
        ...
        private void richTextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            // Set the default color for all text
            richTextBox.SelectAll();
            richTextBox.SelectionColor = Color.Black;

            // Color "create table" green
            ColorText("create table", Color.DarkCyan);
            ColorText("take", Color.DarkOrange);
            ColorText("from", Color.DarkViolet);
            ColorText("add", Color.DarkGreen);
            ColorText("where", Color.DarkRed);
            ColorText("შექმენი ცხრილი", Color.DarkCyan);
            ColorText("ამოიღე", Color.DarkOrange);
            ColorText("აქედან", Color.DarkViolet);
            ColorText("დაამატე", Color.DarkGreen);
            ColorText("სადაც", Color.DarkRed);
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            // If down arrow key is pressed, select the first item in the ListBox
        ...
        private void ColorText(string findText, Color color)
        {
            int index = 0;
            do
            {
                index = richTextBox.Find(findText, index, RichTextBoxFinds.WholeWord);
                if (index > -1)
                {
                    richTextBox.Select(index, findText.Length);
        ...
        public class LineNumberStrip : Control
        {
            ...
            private Brush _offsetBrush = new SolidBrush(Color.Black);
            ...
            public LineNumberStrip(RichTextBox plainTextBox)
            {
                ...
                base.BackColor = System.Drawing.ColorTranslator.FromHtml("#FFFFFF");
                base.Dock = DockStyle.Left;
                base.ForeColor = Color.Black; //System.Drawing.ColorTranslator.FromHtml("#ddd");
                this.OffsetColor = System.Drawing.ColorTranslator.FromHtml("#FFFFFF");
